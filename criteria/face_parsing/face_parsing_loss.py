...
import cv2
import PIL
from criteria.face_parsing.unet import unet
from criteria.face_parsing.utils import generate_label, generate_label_plain
...
class FaceParsingLoss(nn.Module):
    def __init__(self,opts):
        ...
        self.G = unet()
        self.G.load_state_dict(torch.load(opts.model_paths['face_parsing']))
        self.G.eval()
